...
?>
<?php 
$imgPage = do_shortcode('[easy_options id="ServicesBanner"]');
...
<section class="services">
    ...
    <div class="container">
      <div class="services-menu-content">
        ...
        <div class="fire-button menu-button text-center border-blue bg-white" id="fire-button" data-target="#fire">
          <i class="fa fa-cogs text-blue" aria-hidden="true"></i><span class="desktop"> Projetos Complementares</span>
        </div>
        <div class="security-button menu-button text-center border-green bg-white" id="security-button" data-target="#security">
          <i class="fa fa-building text-green" aria-hidden="true"></i><span class="desktop"> Execução de Obras</span>
        </div>
        <div class="bolt-button menu-button text-center border-blue bg-white" id="bolt-button" data-target="#bolt">
          <i class="fa fa-line-chart text-blue" aria-hidden="true"></i><span class="desktop"> Segurança no Trabalho</span>
        </div>
      </div>
    </div>
  </div>
  <div class="service-item hb-green consulting" id="consulting">
    ...
    <div class="container">
      ...
      <div class="service-section-banner whole-block" style="height: 200px; background-image: url('<?php echo do_shortcode('[easy_options id="ServicesConsulting"]'); ?>'); background-position: center center; background-size: cover;"></div>
  ...
  <div class="service-item hb-blue fire" id="fire">
    <div class="container">    
      <div class="service-section-banner whole-block" style="height: 200px; background-image: url('<?php echo do_shortcode('[easy_options id="ServicesFire"]'); ?>'); background-position: center center; background-size: cover;"></div>
      <div class="service-item-title whole-block">
  ...
  <div class="service-item hb-green security" id="security">
    <div class="container">
      <div class="service-section-banner whole-block" style="height: 200px; background-image: url('<?php echo do_shortcode('[easy_options id="ServicesSecurity"]'); ?>');'); background-position: center center; background-size: cover;"></div>
      <div class="service-item-title whole-block">
  ...
  <div class="service-item hb-blue bolt" id="bolt">
    <div class="container">
      <div class="service-section-banner whole-block" style="height: 200px; background-image: url('<?php echo do_shortcode('[easy_options id="ServicesBolt"]'); ?>');'); background-position: center center; background-size: cover;"></div>
      <div class="service-item-title whole-block">
